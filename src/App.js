...
function App() {
  ...
  return (
    <Routes>
      ...
      <Route path="/ DarkModeNav" element={<DarkModeNav />} />
      ...
      <Route
        path="/UseReducerSectionSimple"
        element={<UseReducerSectionSimple />}
      />
      ...
      <Route
        path="/ProjectReact"
        element={<ProjectReact name={name} HandleName={HandleName} />}
      />
      ...
      <Route path="/HKbase" element={<Hookform />} />
